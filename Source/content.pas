...
begin
  ...
  begin
    ...
    begin
      ...
      db.QueryComment.SQL.Text := 'SELECT * FROM likes WHERE id_comment = :id_comment AND id_page = :id_page AND id_liker = :id_liker';
      ...
      begin
        ...
        else if db.QueryComment.IsEmpty then pLikeComment[i].Picture.LoadFromFile('images/like.png');
      end;
...
var QueryLikeCount, id,i:integer;
